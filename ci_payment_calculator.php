...
Version: 1.0.0
Author: Payment Calculator / www.calculator.io
...
function display_calcio_ci_payment_calculator(){
    $page = 'index.html';
...
add_shortcode( 'ci_payment_calculator', 'display_calcio_ci_payment_calculator' );